...
impl AiImageDetector {
    ...
    /// Detects if an image might be AI-generated by checking C2PA data, EXIF, PNG text chunks, and WebP XMP.
    ///
    /// # Returns
    /// `Result<AiDetectionResult, String>` - A result containing `AiDetectionResult`
    /// which indicates whether the image is considered AI-generated and its detected format.
    /// Returns an error string if the image cannot be opened or its format determined.
